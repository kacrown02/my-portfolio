...
const projects = [
  {
    ...
    desc: "RiceSure is a smart farming app that helps monitor and protect rice crops using technology.",
  ...
  },
  {
    ...
    desc: "A convenient online ordering system for PZAM Cups Printing Davao and Packaging Supplies that allows customers to easily browse products, place orders, and manage customized packaging needs anytime, anywhere.",
